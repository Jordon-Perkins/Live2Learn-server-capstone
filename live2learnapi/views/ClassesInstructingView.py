...
from live2learnapi.models import UserProfile, ThisClass, Instructor, Tag, Skill


class ClassesInstructingView(ViewSet):
    ...
    def list(self, request):
        ...
        classes = ThisClass.objects.filter(instructor_class__user=request.auth.user)
