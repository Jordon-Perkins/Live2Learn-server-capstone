...
from live2learnapi.views import  ClassesView, SkillView, ClassesInstructingView, InstructorsView, ClassesAttendingView
...
router.register(r'classes_attending', ClassesAttendingView, 'classes_attending')
